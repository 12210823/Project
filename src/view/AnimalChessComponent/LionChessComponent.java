...
public class LionChessComponent extends ChessComponent {
    ...
    public LionChessComponent(PlayerColor owner, int size, int style) {
        ...
        if(style == 0){
            ...
            if(owner == PlayerColor.BLUE){
                icon = new ImageIcon("resource/AnimalIcons/lionL.png");
            }else icon = new ImageIcon("resource/AnimalIcons/lionR.png");
        }
    }
